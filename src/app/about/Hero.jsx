...
function Hero() {
    return (
        <>
            <div className="w-full min-h-[65vh] p-10 lg:p-20 flex flex-row justify-start items-center bg-white gap-5 bg-hero-about bg-cover bg-center bg-no-repeat border-y-8 border-primary">
